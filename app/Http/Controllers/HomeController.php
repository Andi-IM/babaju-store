...
class HomeController extends Controller
{
    ...
    public function orderReport()
    {
        ...
        // KITA GUNAKAN METHOD startOfMonth() UNTUK MENGAMBIL TANGGAL 1
        $start = Carbon::now()->startOfMonth()->format('Y-m-d H:i:s');

        // DAN METHOD endOfMonth() UNTUK MENGAMBIL TANGGAL TERAKHIR DI BULAN YANG BERLAKU SAAT INI
        ...
        // BUAT QUERY KE DB MENGGUNAKAN METHOD whereBetween() DARI TANGGAL FILTER
    ...
    {
        // EXPLODE TANGGALNYA UNTUK MEMISAHKAN START & END
